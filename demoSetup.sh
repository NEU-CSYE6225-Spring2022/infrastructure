...
aws cloudformation create-stack --stack-name demoVpc --profile demo --template-body file://templates/csye6225-infra.yml --parameters ParameterKey=VpcCIDR,ParameterValue=10.0.0.0/16 \
...
aws cloudformation wait stack-create-complete --stack-name demoVpc --profile demo
