...
PrivateSubnet3CIDR=10.0.6.0/24 AmiId=ami-0360d29047337531b ApplicationInstanceType=t2.micro DbUser=root DbPassword=a9966995395A --capabilities CAPABILITY_NAMED_IAM
