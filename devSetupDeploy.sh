...
PrivateSubnet3CIDR=10.0.6.0/24 AmiId=ami-00f1264a58e5b747d ApplicationInstanceType=t2.micro DbUser=root DbPassword=a9966995395A RandomString=$randomsTR  \
HostedZoneDomainName=dev.manojreddya.me. CodeDeployBucketName=codedeploy.dev.manojreddya.me AccountId=974908798416 SEStopicArn=dev.manojreddya.me --capabilities CAPABILITY_NAMED_IAM
