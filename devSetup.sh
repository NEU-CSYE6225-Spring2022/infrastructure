...
aws cloudformation create-stack --region us-east-1 --stack-name devVpc --profile dev --template-body file://templates/csye6225-infra.yml --parameters ParameterKey=VpcCIDR,ParameterValue=10.0.0.0/16 \
...
aws cloudformation wait stack-create-complete --stack-name devVpc --profile dev --region us-east-1
