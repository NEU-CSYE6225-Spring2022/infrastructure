...
PrivateSubnet3CIDR=10.0.6.0/24 AmiId=ami-0d312d54a7f029c43 ApplicationInstanceType=t2.micro DbUser=root DbPassword=a9966995395A RandomString=$randomsTR \
HostedZoneDomainName=prod.manojreddya.me. CodeDeployBucketName=codedeploy.manojreddya.me --capabilities CAPABILITY_NAMED_IAM
