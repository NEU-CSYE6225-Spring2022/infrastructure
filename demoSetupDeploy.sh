...
PrivateSubnet3CIDR=10.0.6.0/24 AmiId=ami-07a17b420f8d2ce50 ApplicationInstanceType=t2.micro DbUser=root DbPassword=a9966995395A RandomString=$randomsTR \
HostedZoneDomainName=prod.manojreddya.me. --capabilities CAPABILITY_NAMED_IAM
