...
PrivateSubnet3CIDR=10.0.6.0/24 AmiId=ami-0922159300090471a ApplicationInstanceType=t2.micro DbUser=root DbPassword=a9966995395A RandomString=$randomsTR \
