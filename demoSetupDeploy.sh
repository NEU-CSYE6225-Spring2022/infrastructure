...
PrivateSubnet3CIDR=10.0.6.0/24 AmiId=ami-018c989ce308fbcc3 ApplicationInstanceType=t2.micro DbUser=root DbPassword=a9966995395A RandomString=$randomsTR \
